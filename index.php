...
@media(max-width:700px){.edit-mode-bar{top:99px}.angle-nav{font-size:.78rem}.photo-date-navigation{width:100%;margin-left:0;justify-content:space-between}.lightbox-context{margin-right:40px}.lightbox-stage{height:calc(100vh - 250px)}.photo-lightbox img{max-height:calc(100vh - 300px)}}
CSS;}
