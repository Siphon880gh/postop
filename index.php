...
.timeline{position:relative;overflow:visible}.timeline-note-filter{position:sticky;right:0;z-index:2;display:flex;align-self:flex-start;padding-left:5px;background:linear-gradient(90deg,transparent,#fff 28%)}.timeline-note-filter-trigger{display:grid;place-items:center;flex:none;width:38px;height:38px;min-height:38px;padding:0;border:1px solid var(--line);border-radius:50%;background:#fff;color:var(--brand);box-shadow:0 4px 10px rgba(22,50,56,.1)}.timeline-note-filter-trigger:hover{background:#edf5f2;color:var(--brand)}.timeline-note-filter-trigger.is-active{background:var(--brand);border-color:var(--brand);color:#fff;box-shadow:0 5px 12px rgba(15,92,105,.25)}.timeline-note-filter-trigger svg{width:18px;height:18px;display:block}.timeline-note-filter-popover{position:absolute;z-index:8;top:calc(100% + 8px);right:14px;width:min(306px,calc(100vw - 36px));padding:10px;background:#fff;border:1px solid #a9c8c1;border-radius:12px;box-shadow:0 14px 30px rgba(22,50,56,.16)}.timeline-note-filter-popover[hidden]{display:none}.note-filter-field{display:grid;grid-template-columns:minmax(0,1fr) 34px;gap:7px;align-items:center}.note-filter-field input{min-width:0;height:36px;padding:.45rem .65rem}.note-filter-help{display:grid;place-items:center;width:34px;height:34px;min-height:34px;padding:0;border:1px solid #b7d0cb;border-radius:50%;background:#eef5f3;color:#15574f;font-family:Georgia,serif;font-size:.95rem;font-weight:800}.note-filter-help:hover{background:#e0eeea;color:#15574f}.note-filter-presets{display:flex;align-items:baseline;gap:9px;margin-top:8px;color:var(--muted);font-size:.72rem;font-weight:750}.note-filter-preset{min-height:0;padding:0;border:0;border-radius:0;background:transparent;color:var(--brand);font-size:.72rem;font-weight:850;letter-spacing:.02em;text-decoration:underline;text-decoration-thickness:1px;text-underline-offset:3px}.note-filter-preset:hover{background:transparent;color:#0a454f;filter:none}.note-filter-meta{display:flex;align-items:center;justify-content:space-between;gap:10px;min-height:28px;margin-top:7px;color:var(--muted);font-size:.76rem;font-weight:750}.note-filter-meta .small{min-height:28px;padding:.24rem .5rem}.note-filter-help-dialog{width:min(380px,calc(100% - 28px));padding:20px 22px}.note-filter-help-dialog h2{font-size:1.2rem}.note-filter-help-dialog p{margin:.55rem 0 0}
